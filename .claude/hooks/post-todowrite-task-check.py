...
try:
    from audit_logger import log_hook_executed
except ImportError:
...
def main():
    ...
    # Extract session info for audit logging
    ...
    if session_id and cwd:
        try:
            log_hook_executed(cwd, session_id, "post-todowrite-task-check.py", subagent_name, "continue")
        except Exception:
            pass
