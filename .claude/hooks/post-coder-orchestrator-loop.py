...
try:
    from audit_logger import log_hook_executed, log_agent_stop
except ImportError:
    def log_hook_executed(*args, **kwargs):
        pass
    def log_agent_stop(*args, **kwargs):
        pass
...
def main():
    ...
    # Extract working directory and session info
    cwd = data.get("cwd", ".")
    ...
    if session_id and cwd:
        try:
            log_hook_executed(cwd, session_id, "post-coder-orchestrator-loop.py", subagent_name, "continue")
        except Exception:
            pass
